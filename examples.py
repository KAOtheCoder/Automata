...
from NonDeterministicPushDownAutomaton import NonDeterministicPushDownAutomaton

# A deterministic finite automaton that accept only binary numbers that are multipliers of 3
# diagram source: https://en.wikipedia.org/wiki/Deterministic_finite_automaton
dfa = DeterministicFiniteAutomaton(True)
...
nfa = NonDeterministicFiniteAutomaton(True)
